...
function getColourPrinting() {
  let colourPrinting = document.querySelector(
...
function updateBasketPrice() {
  ...
  let decimalBasketPrice =
    Math.round((basketPrice + Number.EPSILON) * 100) / 100;
